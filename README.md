...
| 📅 | **Distributed Transactions** | MassTransit Courier (Routing Slips) | [📖 Readme](./src/Messaging/Playbook.Messaging.MassTransit.Courier/README.md) | [🐛 Issues](https://github.com/TheGresta/DotNet.Architect.Playbook/issues?q=is%3Aissue+label%3Amasstransit) \| [🔄 PRs](https://github.com/TheGresta/DotNet.Architect.Playbook/pulls?q=is%3Apr+label%3Amasstransit) |
