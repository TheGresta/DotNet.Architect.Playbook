...
| ✅ | **Hybrid Caching** | .NET 9 HybridCache | [📖 Readme](./src/Persistence/Playbook.Persistence.HybridCaching/README.md) | [🐛 Issues](https://github.com/TheGresta/DotNet.Architect.Playbook/issues?q=is%3Aissue+label%3Ahybrid-cache) \| [🔄 PRs](https://github.com/TheGresta/DotNet.Architect.Playbook/pulls?q=is%3Apr+label%3Ahybrid-cache) |
