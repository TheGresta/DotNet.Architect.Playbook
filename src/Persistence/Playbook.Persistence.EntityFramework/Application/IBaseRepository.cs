...
public interface IBaseRepository<TEntity> where TEntity : Entity
{
    ...
    /// <summary>
    /// Asynchronously retrieves a paged result set of entities.
    /// </summary>
    /// <param name="predicate">An optional filter to apply.</param>
    /// <param name="orderBy">An optional ordering function.</param>
    /// <param name="index">The zero-based page index. Default is 0.</param>
    /// <param name="size">The page size. Default is 10.</param>
    /// <param name="cancellationToken">A <see cref="CancellationToken"/> to observe.</param>
    /// <returns>A <see cref="Task{TResult}"/> containing a <see cref="Paginate{T}"/> wrapper for the entities.</returns>
